...
int main()
{
    // note: we don't need to use .clear() if we just
    // initialized the set/map
    ...
    */
    ...
    // then the internal content of mapper/used_values is not fully
    // known (implementation dependent)

    // iterating through the keys will give a jumbled output as the
    // keys are hashed into various slots
    ...
    // there is no lower_bound and upper_bound in unordered_set
